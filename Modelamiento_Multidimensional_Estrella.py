...
def transform():
    ...
    log(logfile, "-------------------------------------------------------------")
    return df_orders_fact,df_customers,df_employees,df_location,df_product,df_shipper
   
def load():
    """ Connect to the PostgreSQL database server """
    conn_string = 'postgresql://postgres:12345@localhost:5433/DW_Northwind_Estrella'
...
if __name__ == '__main__':
    ...
    extract()
    (df_orders_fact,df_customers,df_employees,df_location,df_product,df_shipper) = transform()
    load()
